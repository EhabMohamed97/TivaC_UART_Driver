...
#define DioConf_GREEN_LED_CHANNEL_ID_INDEX        (uint8)0x01
#define DioConf_BLUE_LED_CHANNEL_ID_INDEX          (uint8)0x02
...
#define DioConf_GREEN_LED_CHANNEL_NUM             (Dio_ChannelType)3 /* Pin 2 in PORTF */
#define DioConf_BLUE_LED_CHANNEL_NUM            (Dio_ChannelType)2   /*Pin 3 in PORTF */
