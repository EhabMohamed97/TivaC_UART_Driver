...
typedef enum
{
  PIN_DEFAULT_CONFIG, PIN_OUT_HIGH, PIN_IN_PULLUP_HIGH, PIN_IN_PULL_DOWN, PIN_OUT_LOW, PIN_IN_PULLUP_LOW, PA0_U1RX, PA1_U1TX
}MajorPinsConfig;
...
STATIC const Port_configChannel pinsConfigSettings[] = { {PORT_PIN_IN, STD_LOW, OFF, PIN_DIO_MODE, STD_ON, STD_ON},
                                                         ...
                                                         {PORT_PIN_IN, STD_LOW, PULL_UP, PIN_DIO_MODE, STD_OFF, STD_OFF},
                                                         {PORT_PIN_IN, STD_LOW, OFF, 1, STD_OFF, STD_OFF},
                                                         {PORT_PIN_OUT, STD_LOW, OFF, 1, STD_OFF, STD_OFF}
                                                       };
 ...
 */
const Port_ConfigType Port_Configuration = {  &pinsConfigSettings[PA0_U1RX],                 /* PA0 */
                                              &pinsConfigSettings[PA1_U1TX],                 /* PA1 */
                                              ...
                                              &pinsConfigSettings[PIN_OUT_LOW],                 /* PF3 */
